...
| Name | Version |
|------|------:|
| <a href="https://github.com/cattle-ops/terraform-aws-gitlab-runner" target="_blank">cattle-ops/gitlab-runner/aws</a> | 9.5.1 |
...
| runner_ingress_rules                     | Map of ingress rules for the Runner Manager security group                                 | `map(object)` | `{}`                                          | no       |
| runner_egress_rules                      | Map of egress rules for the Runner Manager security group (default allows HTTPS IPv4/IPv6) | `map(object)` | see below                                     | no       |
